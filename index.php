...
{
$ret=mysql_query("SELECT * FROM admin WHERE nazwa_uzytkownika='".$_POST['nazwa_uzytkownika']."' and haslo='".$_POST['haslo']."'");
						...
						<fieldset>
							...
							<div class="form-group">
								<span class="input-icon">
									<input type="text" class="form-control" name="nazwa_uzytkownika" placeholder="Nazwa użytkownika">
									<i class="fa fa-user"></i> </span>
							</div>
							<div class="form-group form-actions">
								<span class="input-icon">
									<input type="password" class="form-control haslo" name="haslo" placeholder="Hasło"><i class="fa fa-lock"></i>
									 </span>
							</div>
